...
class DialogActions(customtkinter.CTkToplevel):
    ...
    def __init__(self, titre):
        ...
        btn_valider = customtkinter.CTkButton(self, text="Valider",
...
bouton_fichier = customtkinter.CTkButton(frame_gauche, text="ouvrir fichier...", command=selection_fichier)
bouton_fichier.grid(row=0, column=0, padx=15, pady=(15, 5), sticky="ew")

bouton_dossier = customtkinter.CTkButton(frame_gauche, text="ouvrir dossier...", command=selection_dossier)
...
chemin_entry = customtkinter.CTkEntry(app, placeholder_text="chemin du fichier ou du dossier")
...
btn_enrich = customtkinter.CTkButton(frame_actions, text="Enrich",
                                     command=lambda: ouvrir_dialog("Enrich"))
btn_enrich.grid(row=0, column=0, padx=15, pady=(15, 5))

btn_register = customtkinter.CTkButton(frame_actions, text="Manual Enrich",
                                       command=lambda: ouvrir_dialog("Manual Enrich"))
btn_register.grid(row=1, column=0, padx=15, pady=5)

btn_output = customtkinter.CTkButton(frame_actions, text="Register",
                                     command=lambda: ouvrir_dialog("Register"))
btn_output.grid(row=2, column=0, padx=15, pady=5)

btn_autre = customtkinter.CTkButton(frame_actions, text="Set Output",
                                    command=lambda: ouvrir_dialog("Set Output"))
